  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-semibold text-ink">Loyalty Tiers, Accounts &amp; Subscriptions</h1>
      </div>
        ...
        <details className="border-b border-black/5">
          ...
          >
            ...
            <input
              ...
              className="rounded-md border border-black/10 px-3 py-2 text-[13px] sm:col-span-2 lg:col-span-1"
            />
            <button
              type="submit"
                ...
                <td className="px-5 py-3">
                  <form action={adjustLoyaltyPoints} className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      className="rounded-md border border-black/10 px-2 py-1 text-[12px] text-ink"
                    >
                    ...
                    <input
                      ...
                      step="1"
                      placeholder="+/- pts"
                      className="w-20 rounded-md border border-black/10 px-2 py-1 text-[12px]"
                    />
                    <button
                      type="submit"
