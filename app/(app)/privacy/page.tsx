...
export default async function PrivacyPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-semibold">Consent & Data Rights</h1>
        <p className="text-slate-500">Customer consent records and GDPR-style data rights requests.</p>
      </div>
          ...
          <details className="relative">
            ...
            >
              ...
              <div>
                ...
                <select name="consent_type" required className="mt-1 w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm">
              ...
              <div>
                ...
                <select name="status" required className="mt-1 w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm">
              ...
              <div>
                ...
                <select name="source" required className="mt-1 w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm">
          ...
          <details className="relative">
            ...
            >
              ...
              <div>
                ...
                <select name="request_type" required className="mt-1 w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm">
                  <option value="">Select type</option>
