...
export default async function ClaimsPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-semibold">Claims & Collection Points</h1>
        <p className="text-slate-500">Damage/loss compensation claims and branch collection point directory.</p>
      </div>
          ...
          <details className="relative">
            ...
            >
              <div>
                ...
                <select name="complaint_id" required className="mt-1 w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm">
              ...
              <div>
                ...
                <select name="garment_id" className="mt-1 w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm">
              ...
              <tr key={c.id} className="border-b border-slate-100">
                ...
                <td className="py-2">
                  <form action={updateClaimStatus} className="flex items-center gap-1">
                    ...
                    <select name="status" defaultValue={c.status} className="rounded-md border border-slate-300 px-1 py-1 text-xs">
                      {statusOptions.map((s) => (
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-5">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-lg font-semibold">Collection Points</h2>
          <details className="relative">
            <summary className="cursor-pointer list-none rounded-md bg-slate-900 px-3 py-1.5 text-sm font-medium text-white">
